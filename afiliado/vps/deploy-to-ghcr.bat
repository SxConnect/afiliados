@echo off
REM Script completo para build e deploy da imagem Docker para GHCR
REM Arquitetura 10K Usuarios - v2.0.0
...
echo ========================================
echo   VPS Docker Build ^& Deploy to GHCR
...
if not exist "Dockerfile" (
    ...
    echo Execute este script do diretorio afiliado/vps
    exit /b 1
)
